			...
			<article>
				...
				<div id="contentszone">
					...
					<div id="contentscover"><!-- コンテンツ横の余白16pxを作るための箱 -->
						<h3>Ｑ.よくある質問</h3>
						<p>Ａ.テキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキストテキスト</p>
						<h3>Ｑ.</h3>
						<p>Ａ.</p>
						<h3>Ｑ.</h3>
						<p>Ａ.</p>
